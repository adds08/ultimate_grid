...
/// Header cell content used by Datagrid + Stress-test: column header label
/// with sort/filter indicators and a kebab affordance for the popup menu.
class HeaderLabel extends StatelessWidget {
  final GridController controller;
  final ColId colId;
  const HeaderLabel(
      {super.key, required this.controller, required this.colId});
